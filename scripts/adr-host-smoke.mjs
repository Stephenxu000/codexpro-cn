...
if (invocations.filter((args) => args[0] === 'host-begin').length !== 3) throw new Error('unexpected host-begin count across normal + stale recovery flows');
if (invocations.filter((args) => args[0] === 'host-complete').length !== 3) throw new Error('unexpected host-complete count across normal + stale recovery flows');
